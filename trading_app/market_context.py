...
def get_market_context() -> dict:
    """
    Analyze market conditions for DE and US markets.

    Returns dict with:
      - DE: {index_name, trend, above_ema50, above_ema200, rsi, change_1m}
      - US: {index_name, trend, above_ema50, above_ema200, rsi, change_1m}
      - vix_level: float or None
      - vix_regime: "low" / "normal" / "high" / "extreme"
    """
    de = _analyze_index("^GDAXI", "DAX")
    us = _analyze_index("^GSPC", "S&P 500")
